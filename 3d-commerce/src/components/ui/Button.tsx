...
const variants: Record<ButtonVariant, string> = {
  primary: `
    gradient-primary border border-primary/10 text-white
    shadow-[0_8px_25px_rgba(109,40,217,0.20)]
    hover:brightness-110 hover:border-primary/50
    hover:shadow-[0_10px_30px_rgba(109,40,217,0.28)]
    active:scale-[0.98]
  `,
  outline: `
    border border-border bg-transparent text-foreground
    hover:border-primary/60 hover:bg-primary/[0.06] hover:text-primary-hover
  `,
  ghost: `
